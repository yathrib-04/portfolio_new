      ...
      constructor(e) {
        ...
        (this.position = new T.Vector3()),
          ...
          (this.reach = function (e, t) {
            var i = new T.Vector3();
            return (
              i.subVectors(e, this.position), i.multiplyScalar(t), i
            );
          }),
          (this.alignment = function (e) {
            ...
            for (var r = 0, h = e.length; r < h; r++)
              Math.random() > 0.6 ||
                ((i = (t = e[r]).position.distanceTo(this.position)) >
                  0 &&
                  i <= s &&
                  (n.add(t.velocity), o++));
            if (o > 0) {
          ...
          (this.cohesion = function (e) {
            ...
            for (var h = 0, c = e.length; h < c; h++)
              Math.random() > 0.6 ||
                ((i = (t = e[h]).position.distanceTo(this.position)) >
                  0 &&
                  i <= r &&
                  (n.add(t.position), s++));
    ...
    class E extends l {
      ...
      initComputeRenderer() {
        ...
        !(function (e) {
          ...
          (this.velocityVariable.material.defines.BOUNDS =
            C.toFixed(2)),
      ...
      valuesChanger() {
        this.velocityUniforms &&
          ...
          (this.velocityUniforms.speedLimit.value =
            this.options.speedLimit),
        ...
        if ((e > 1 && (e = 1), (this.last = this.now), M))
          ...
          for (var t = 0, i = e.length; t < i; t++) {
            (o = n[t]),
              ...
              (s.rotation.z = Math.asin(
                o.velocity.y / o.velocity.length()
              )),
              (s.phase =
                (s.phase + (Math.max(0, s.rotation.z) + 0.1)) %
                62.83);
            const i = 16,
              r = 13;
